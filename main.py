...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.frame_pad = ttk.LabelFrame(self.master, text="Write Area")
        ...
        action_frame.place(x=430, y=100, width=70, height=50)
        ...
        self.label = ttk.Label(self.master, text="Type a word you wanna practice:", anchor="center", font=("微软雅黑", 10))
        self.label.place(x=0, y=0, width=250, height=60)
        self.numEntry = Entry(self.master)
        self.numEntry.place(x=20, y=50, width=500, height=30)
