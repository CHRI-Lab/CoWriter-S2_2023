...
RUN apt-get update && apt-get install -y \
    ...
    python3-pip libgmock-dev patchelf git cmake \
    ros-noetic-tf ros-noetic-cv-bridge ros-noetic-image-transport ros-noetic-image-geometry \
    libyaml-cpp-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev

# Install Python packages
RUN pip3 install qibuild scikit-build toml matplotlib openai google-cloud scikit-learn recordtype --upgrade google-api-python-client --upgrade google-cloud-speech
