...
def visualize_traj(points, FRAME, WRITE_MULTIPLE_SHAPES, shapeCount, pub_markers):
    ...
    - FRAME (str): The frame ID for the marker.
    - WRITE_MULTIPLE_SHAPES (bool): A flag indicating whether to write multiple shapes.
    - shapeCount (int): The shape count if writing multiple shapes.
    - pub_markers (rospy.Publisher): The publisher object for publishing the marker.
