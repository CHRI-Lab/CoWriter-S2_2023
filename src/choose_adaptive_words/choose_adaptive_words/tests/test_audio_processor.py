...
from audio_processor import AudioProcessor, SpeechTranscriber
...
if __name__ == '__main__':
    ...
    rostest.rosrun('letter_learning_interaction', 'test_audio_processor',
                   TestSpeechTranscriber, sys.argv)
    rostest.rosrun('letter_learning_interaction', 'test_audio_processor',
                   TestAudioProcessor, sys.argv)
