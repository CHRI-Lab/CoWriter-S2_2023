...
class Manager(QtWidgets.QDialog):
    ...
    def buttonWordToWriteClicked(self):
        print(f'[buttonWordToWriteClicked] called')
    ...
    def buttonSendRobotClicked(self):
        ...
        for d in data:
            print(f'[Manager][buttonSendRobotClicked] d.x = {d.x}  |  self.activity.tactileSurface.convert_pix_meter = {self.activity.tactileSurface.convert_pix_meter}')
            print(f'[Manager][buttonSendRobotClicked] d.y = {d.y}  |  self.activity.tactileSurface.convert_pix_meter + self.activity.tactileSurface.height()*self.activity.tactileSurface.convert_pix_meter = {self.activity.tactileSurface.convert_pix_meter + self.activity.tactileSurface.height()*self.activity.tactileSurface.convert_pix_meter}')
        ...
        print(f'[Manager][buttonSendRobotClicked] words_drawn = {words_drawn}')
