...
chilitag).
# TODO: Dont know if it works. Not tested yet
"""
...
if __name__ == "__main__":
    ...
    POSITIONING_METHOD = rospy.get_param(
    ...
    if POSITIONING_METHOD.lower() == "fiducial_marker_detection":
        TAG_FRAME = rospy.get_param(
            "~tag_frame_id", "tag_1"
        )  # ? name of frame to detect writing surface with
        ROTATE_TAG_FRAME = rospy.get_param(
        ...
        while not rospy.is_shutdown():
            ...
            try:
                tf_listener.waitForTransform(
                    "map", TAG_FRAME, rospy.Time.now(), rospy.Duration(5.0)
                )
            ...
            tf_broadcaster.sendTransform(
                trans, (o.x, o.y, o.z, o.w), rospy.Time.now(), FRAME_ID, "map"
            )
