...
class AudioProcessor:
    ...
    def run(self):
        ...
        """
        rospy.loginfo("Starting start_recording().")
        self.start_recording()
        # Record for chunk_duration seconds
        time.sleep(self.chunk_duration)
        rospy.loginfo("Finished start_recording().")
        rospy.loginfo("Starting stop_recording()")
        self.stop_recording()
        rospy.loginfo("Finished stop_recording()")
        rospy.loginfo("Starting process_audio()")
        self.process_audio()
        rospy.loginfo("Finished process_audio()")
    ...
    def process_audio(self):
        ...
        rospy.loginfo('Transcription is %s' % transcription_chunk)
